...
KNOWN_UNMAPPED_RELATIONS: dict[tuple[Tool, str, str], str] = {
    ...
    (Tool.ZOHO, 'action', '👯\u200d♀️ チェーンリスト'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
    ...
    (Tool.ZOHO, 'chain', '連絡先'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
    ...
    (Tool.ZOHO, 'product', '案件管理'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
    (Tool.ZOHO, 'project', 'アクション履歴'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
    (Tool.ZOHO, 'project', 'サービス・商品'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
    (Tool.ZOHO, 'project', 'チェーン'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
    (Tool.ZOHO, 'project', '取引先マスター'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
    (Tool.ZOHO, 'project', '連絡先'): "リレーション。取り込むには相手ページの名寄せが要る（取引先マスターのみ実装済み）",
}
